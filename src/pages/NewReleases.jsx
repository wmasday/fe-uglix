...
import { fetchNewReleases, fetchDropdownData } from '../api'
...
export default function NewReleases() {
  ...
  const loadMovies = async (page = 1) => {
    try {
      setLoading(true)
      setError('')
      const response = await fetchNewReleases({ page, perPage: 20 })
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                >
                  Discover the latest movies and series from the past 2 years
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-6">
              ...
              >
                <FaStar className="text-lg" style={{ color: 'var(--primary-color)' }} />
                <span className="text-sm font-medium" style={{ color: 'var(--text-primary)' }}>
                  {totalItems} New Releases
                </span>
              </motion.div>
              ...
              <motion.div
                ...
                whileHover={{ scale: 1.02 }}
              >
                <FaCalendarAlt className="text-lg" style={{ color: 'var(--secondary-color)' }} />
                <span className="text-sm font-medium" style={{ color: 'var(--text-primary)' }}>
                  Updated Recently
                </span>
              </motion.div>
